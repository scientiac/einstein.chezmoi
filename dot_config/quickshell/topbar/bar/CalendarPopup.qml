...
Item {
	...
	implicitWidth: 320
	implicitHeight: calGrid.implicitHeight + headerRow.implicitHeight + dayLabels.implicitHeight + 20
		...
		Item {
			...
			Row {
				...
				Text {
					...
					color: "#ffffff"
					font { pixelSize: 16; family: "FantasqueSansM Nerd Font"; weight: Font.Bold }
					width: 130
				...
				Rectangle {
					...
					Text {
						...
						readonly property bool isToday: {
							...
							return modelData.current && modelData.day === today.getDate()
								&& root.displayMonth === today.getMonth()
								&& root.displayYear === today.getFullYear();
						}
						
						color: isToday ? "#ffffff" : (modelData.current ? "#cccccc" : "#444444")
						font {
							pixelSize: 14
							family: "FantasqueSansM Nerd Font"
							weight: isToday ? Font.Bold : (modelData.current ? Font.Normal : Font.Light)
						}
					}
				}
			}
